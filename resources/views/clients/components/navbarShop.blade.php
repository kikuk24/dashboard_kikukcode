<div class="bg-white shadow-sm sticky top-0 z-[100]">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-1 md:py-4">
        <div class="flex items-center justify-between md:justify-start ">
            ...
            <a href="#" class="font-bold text-gray-700 text-2xl">Kikukshop.</a>

            <div class="hidden md:flex space-x-3 flex-1 lg:ml-8">
                <a href="#"
                    class="px-2 py-2 hover:bg-gray-100 rounded-lg text-gray-400 hover:text-gray-600">Website</a>
                <a href="#"
                    class="px-2 py-2 hover:bg-gray-100 rounded-lg text-gray-400 hover:text-gray-600">Digital</a>
                <a href="#"
