        ...
        <div class="xl:max-w-7xl lg:px-8 mx-auto px-4 sm:px-6 md:px-4 lg:max-w-6xl">
            <div class="flex flex-col">
                <div class="flex-1 max-w-xl">
                    <h1 class="text-2xl font-bold tracking-tighter text-foreground sm:text-3xl lg:text-5xl">Semua Kategori
                    </h1>
                </div>
                <div class="mt-4 lg:mt-6">
                    <div class="sm:hidden block"><button
                            ...
                            data-state="closed"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                fill="none" viewBox="0 0 24 24" class="w-4 -ml-1 h-4 text-muted-foreground mr-2">
