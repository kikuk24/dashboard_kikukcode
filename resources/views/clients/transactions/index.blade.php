    ...
    <div class="max-w-2xl mx-auto px-4">
      ...
      <div class="mb-6">
        <div class="">
          ...
          <p class="font-bold text-gray-900">Harga : Rp {{ $product->discount_price }}</p>
        </div>
      </div>
      <form action="{{ route('transaction.buy') }}" method="POST" class="mb-6" id="payment-form">
        ...
        <div class="py-2 mb-4 rounded-lg rounded-t-lg border border-gray-200">
          ...
          <input type="hidden" name="price" value="{{ $product->discount_price }}" id="price">
          <input type="hidden" name="total" value="{{ $product->discount_price }}" id="total">
        ...
        <div class="py-2 mb-4 rounded-lg rounded-t-lg border border-gray-200">
          ...
          <input type="number" class="w-full text-sm text-gray-900 border-0 focus:ring-0 focus:outline-none px-2"
