<div class="card shadow mb-4">
  <div class="card-header py-3">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
      ...
      <a href="{{route('dashboard.form-post')}}" class="btn btn-info ml-2 mt-2"><i class="fas fa-plus"></i>
        Tambah</a>
    </div>
              ...
              <th colspan="2">
                <form action="{{ route('posts.destroy-all') }}" method="post">
                  ...
                  <button type="submit" class="btn btn-danger"
                    onclick="return confirm('Apakah anda yakin ingin menghapus semua data ini?')">Delete All</button>
